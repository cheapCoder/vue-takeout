      ...
      <section class="section">
        ...
        <div class="activity">
          <div
            ...
            v-for="(activity, index) in info.supports"
            :key="index"
            :class="tagType[activity.type]"
          >
...
export default {
  ...
  data() {
    return {
      tagType: ["activity-green", "activity-red", "activity-orange"],
    };
  },
  computed: {
    ...mapState({
  ...
  methods: {
    initScroll() {
      ...
      if (this.scrollY) {
        ...
        this.scrollY = new BScroll(".shop-info", {
          click: true,
      ...
      if (this.scrollX) {
        ...
        const picUl = this.$refs.picture;
        const picWidth = 120;
        const space = 6;
        const picNum = this.$refs.picture.children.length;
        picUl.style.width = (picWidth + space) * picNum - space + "px";
